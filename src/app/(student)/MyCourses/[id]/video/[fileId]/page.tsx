      ...
      try {
        ...
        for (const section of courseData.sections || []) {
          for (const file of section.files || []) {
            // For debugging
            console.log(
              `Comparing file ID: ${file.id} with requested fileId: ${fileId}`
            );
        ...
        setError(
          `Failed to load video (ID: ${fileId}). Please try again later.`
        );
      } finally {
        setLoading(false);
      }
    ...
    <div className="max-w-5xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="text-gray-700">
          This video is part of your course materials. Use the video player
          controls to adjust playback, volume, or enter fullscreen mode. Click
          the video to play or pause.
        </p>
